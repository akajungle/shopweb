...
var cart_list_component_1 = require("./cart-list.component");
var cartRoutes = [
    { path: 'cart/:id', component: cart_list_component_1.CartComponent }
];
...
CartRoutingModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(cartRoutes)
        ],
        exports: [
